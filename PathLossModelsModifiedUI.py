...
scenario = ctk.CTkButton(root, fg_color="#FFE15D", text_color="#DC3535", hover_color="#FFE15D", height=35,
                         text_font=("Ariel", 16, "bold"), text="SELECT SCENARIO FOR CALCULATING PATH LOSS")
scenario.grid(row=0, column=1, pady=15)

button_1 = ctk.CTkButton(root, fg_color="#3B9AE1", text_color="white", hover_color="#4C9AE1",
                         height=70, text_font=("Helvetica", 16), width=380,
                         text="Indoor Transmission Loss Model", command=indoor_transmission)
button_1.grid(row=1, column=0, padx=45, pady=50)
...
button_2.grid(row=2, column=0, padx=45, pady=50)
...
button_3.grid(row=3, column=0, padx=45, pady=50)
...
button_4.grid(row=4, column=0, padx=45, pady=50)
...
button_7.grid(row=3, column=1, padx=45, pady=50)
...
button_8.grid(row=4, column=1, padx=45, pady=50)
...
button_11.grid(row=3, column=2, padx=45, pady=50)
...
button_12.grid(row=4, column=2, padx=45, pady=50)
